...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["angular-nest-docker-example-root"]], decls: 8, vars: 5, consts: [[2, "text-align", "center"], ["width", "450", "src", "https://raw.githubusercontent.com/nrwl/nx/master/nx-logo.png"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! C:\Repos\nx-angular-nest-docker-example\apps\angular-nest-docker-example\src\main.ts */"./src/main.ts");
